...
app.get("/",(req,res)=>{
  res.send("Please put (/ecommerce) or (/ecommerce/products) or (/ecommerce/products/1) in front of the above link [localhost:3000] in the browser. Note: For password checking, that either it is strong or weak, we have to use Postman because its POST method." )
})
